...
project = "Panel Studyy Labour Market and Social Security (PASS) Data Preparation"
copyright = "2019-, Aysu Avci, Melih Damar"
...
latex_documents = [
    (
        ...
        """Documentation of the Panel Studyy Labour Market and Social Security (PASS) Data Preparation project""",
        "Aysu Avci, Melih Damar",
        "manual",
    )
]
